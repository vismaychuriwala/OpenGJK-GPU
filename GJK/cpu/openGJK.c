...
inline static void support(gkPolytope* restrict body,
  ...
  if (better != -1) {
    const gkFloat* best = &body->coord[better * 3];
    body->s[0] = best[0];
    body->s[1] = best[1];
    body->s[2] = best[2];
    body->s_idx = better;
...
inline static void W0D(const gkPolytope* bd1, const gkPolytope* bd2,
                       gkSimplex* smp) {
  const gkFloat* w00 = &bd1->coord[smp->vrtx_idx[0][0] * 3];
  const gkFloat* w01 = &bd2->coord[smp->vrtx_idx[0][1] * 3];
  for (int t = 0; t < 3; t++) {
...
inline static void W1D(const gkPolytope* bd1, const gkPolytope* bd2,
  ...
  const gkFloat* w00 = &bd1->coord[smp->vrtx_idx[0][0] * 3];
  const gkFloat* w01 = &bd2->coord[smp->vrtx_idx[0][1] * 3];
  const gkFloat* w10 = &bd1->coord[smp->vrtx_idx[1][0] * 3];
  const gkFloat* w11 = &bd2->coord[smp->vrtx_idx[1][1] * 3];
  for (int t = 0; t < 3; t++) {
...
inline static void W2D(const gkPolytope* bd1, const gkPolytope* bd2,
  ...
  const gkFloat* w10 = &bd1->coord[smp->vrtx_idx[1][0] * 3];
  const gkFloat* w11 = &bd2->coord[smp->vrtx_idx[1][1] * 3];
  const gkFloat* w20 = &bd1->coord[smp->vrtx_idx[2][0] * 3];
  const gkFloat* w21 = &bd2->coord[smp->vrtx_idx[2][1] * 3];
  for (int t = 0; t < 3; t++) {
...
inline static void W3D(const gkPolytope* bd1, const gkPolytope* bd2,
  ...
  const gkFloat* w20 = &bd1->coord[smp->vrtx_idx[2][0] * 3];
  const gkFloat* w21 = &bd2->coord[smp->vrtx_idx[2][1] * 3];
  const gkFloat* w30 = &bd1->coord[smp->vrtx_idx[3][0] * 3];
  const gkFloat* w31 = &bd2->coord[smp->vrtx_idx[3][1] * 3];
  for (int t = 0; t < 3; t++) {
    smp->witnesses[0][t] =
