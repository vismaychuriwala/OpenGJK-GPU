...
plt.plot(poly_32['Polytopes'], poly_32['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='Regular GPU', color='#e74c3c')
plt.plot(poly_32['Polytopes'], poly_32['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='Warp-Parallel GPU', color='#3498db')
...
ax.plot(poly_32['Polytopes'], poly_32['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='Regular GPU', color='#e74c3c')
ax.plot(poly_32['Polytopes'], poly_32['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='Warp-Parallel GPU', color='#3498db')
...
plt.figure(figsize=(10, 6))
plt.plot(poly_64['Polytopes'], poly_64['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='Regular GPU', color='#e74c3c')
plt.plot(poly_64['Polytopes'], poly_64['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='Warp-Parallel GPU', color='#3498db')
...
fig, ax = plt.subplots(figsize=(10, 6))
ax.plot(poly_64['Polytopes'], poly_64['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='Regular GPU', color='#e74c3c')
ax.plot(poly_64['Polytopes'], poly_64['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='Warp-Parallel GPU', color='#3498db')
...
plt.figure(figsize=(10, 6))
plt.plot(vert_32['Vertices'], vert_32['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='Regular GPU', color='#e74c3c')
plt.plot(vert_32['Vertices'], vert_32['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='Warp-Parallel GPU', color='#3498db')
...
fig, ax = plt.subplots(figsize=(10, 6))
ax.plot(vert_32['Vertices'], vert_32['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='Regular GPU', color='#e74c3c')
ax.plot(vert_32['Vertices'], vert_32['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='Warp-Parallel GPU', color='#3498db')
...
plt.figure(figsize=(10, 6))
plt.plot(vert_64['Vertices'], vert_64['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='Regular GPU', color='#e74c3c')
plt.plot(vert_64['Vertices'], vert_64['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='Warp-Parallel GPU', color='#3498db')
...
fig, ax = plt.subplots(figsize=(10, 6))
ax.plot(vert_64['Vertices'], vert_64['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='Regular GPU', color='#e74c3c')
ax.plot(vert_64['Vertices'], vert_64['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='Warp-Parallel GPU', color='#3498db')
...
ax.plot(poly_32['Polytopes'], poly_32['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='32-bit Regular GPU', color='#e74c3c')
ax.plot(poly_32['Polytopes'], poly_32['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='32-bit Warp-Parallel GPU', color='#3498db')
ax.plot(poly_32['Polytopes'], poly_32['CPU_ms'], 'D-', linewidth=2.5, markersize=7, label='32-bit CPU', color='#2ecc71')
ax.plot(poly_64['Polytopes'], poly_64['Regular_GPU_ms'], 'o--', linewidth=2, markersize=8, label='64-bit Regular GPU', color='#e74c3c', alpha=0.6)
ax.plot(poly_64['Polytopes'], poly_64['Warp_Parallel_GPU_ms'], 's--', linewidth=2, markersize=8, label='64-bit Warp-Parallel GPU', color='#3498db', alpha=0.6)
...
fig, ax = plt.subplots(figsize=(12, 6))
ax.plot(vert_32['Vertices'], vert_32['Regular_GPU_ms'], 'o-', linewidth=2.5, markersize=8, label='32-bit Regular GPU', color='#e74c3c')
ax.plot(vert_32['Vertices'], vert_32['Warp_Parallel_GPU_ms'], 's-', linewidth=2.5, markersize=8, label='32-bit Warp-Parallel GPU', color='#3498db')
ax.plot(vert_32['Vertices'], vert_32['CPU_ms'], 'D-', linewidth=2.5, markersize=7, label='32-bit CPU', color='#2ecc71')
ax.plot(vert_64['Vertices'], vert_64['Regular_GPU_ms'], 'o--', linewidth=2, markersize=8, label='64-bit Regular GPU', color='#e74c3c', alpha=0.6)
ax.plot(vert_64['Vertices'], vert_64['Warp_Parallel_GPU_ms'], 's--', linewidth=2, markersize=8, label='64-bit Warp-Parallel GPU', color='#3498db', alpha=0.6)
